# spark-submit EighteenthCol.py /user/ly976/NYPD_Complaint_Data_Historic.csv EighteenthCol.txt                                                                                                                      
# hfs -getmerge EighteenthCol.txt EighteenthCol.txt                                                                                                                                                                 
...
def fun(input):
    if input[17] == "":
        return "999\tText\tPark\tNULL"
    else:
        return "%s\tText\tPark\tVALID" % (input[17])
