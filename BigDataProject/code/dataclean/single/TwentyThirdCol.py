# spark-submit TwentyThirdCol.py /user/ly976/NYPD_Complaint_Data_Historic.csv TwentyThirdCol.txt                                                                                                                      
# hfs -getmerge TwentyThirdCol.txt TwentyThirdCol.txt                                                                                                                                                                 
...
def fun(input):
    if input[22] == "":
        return "999\tNumber\tLongitude\tNULL"
    else:
        return "%s\tNumber\tLongitude\tVALID" % (input[22])
