# spark-submit TwentyFirstCol.py /user/ly976/NYPD_Complaint_Data_Historic.csv TwentyFirstCol.txt                                                                                                                      
# hfs -getmerge TwentyFirstCol.txt TwentyFirstCol.txt                                                                                                                                                                 
...
def fun(input):
    if input[20] == "":
        return "999\tNumber\tY-coordinate\tNULL"
    else:
        return "%s\tNumber\tY-coordinate\tVALID" % (input[20])
