# spark-submit NineteenthCol.py /user/ly976/NYPD_Complaint_Data_Historic.csv NineteenthCol.txt                                                                                                                      
# hfs -getmerge NineteenthCol.txt NineteenthCol.txt                                                                                                                                                                 
...
def fun(input):
    if input[18] == "":
        return "999\tText\tHousing\tNULL"
    else:
        return "%s\tText\tHousing\tVALID" % (input[18])
