# spark-submit TwentySecondCol.py /user/ly976/NYPD_Complaint_Data_Historic.csv TwentySecondCol.txt                                                                                                                      
# hfs -getmerge TwentySecondCol.txt TwentySecondCol.txt                                                                                                                                                                 
...
def fun(input):
    if input[21] == "":
        return "999\tNumber\tLatitude\tNULL"
    else:
        return "%s\tNumber\tLatitude\tVALID" % (input[21])
