# spark-submit TwentyFourthCol.py /user/ly976/NYPD_Complaint_Data_Historic.csv TwentyFourthCol.txt                                                                                                                      
# hfs -getmerge TwentyFourthCol.txt TwentyFourthCol.txt                                                                                                                                                                 
...
def fun(input):
    if input[23] == "":
        return "999\tNumber\tLocation\tNULL"
    else:
        return "%s\tNumber\tLocation\tVALID" % (input[23])
